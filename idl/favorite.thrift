...
//}
service FavoriteSrv{
    douyin_favorite_action_response FavoriteAction(1:douyin_favorite_action_request req)  //点赞或取消点赞
    douyin_favorite_list_response FavoriteList(1:douyin_favorite_list_request req) // 返回点赞视频列表
}
