...
func NewFavoriteSrvClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *FavoriteSrvClient {
	return &FavoriteSrvClient{
		c: thrift.NewTStandardClient(f.GetProtocol(t), f.GetProtocol(t)),
	}
}

func NewFavoriteSrvClientProtocol(t thrift.TTransport, iprot thrift.TProtocol, oprot thrift.TProtocol) *FavoriteSrvClient {
	return &FavoriteSrvClient{
		c: thrift.NewTStandardClient(iprot, oprot),
	}
}

func NewFavoriteSrvClient(c thrift.TClient) *FavoriteSrvClient {
	return &FavoriteSrvClient{
		c: c,
	}
}

func (p *FavoriteSrvClient) Client_() thrift.TClient {
	return p.c
}

func (p *FavoriteSrvClient) FavoriteAction(ctx context.Context, req *DouyinFavoriteActionRequest) (r *DouyinFavoriteActionResponse, err error) {
	var _args FavoriteSrvFavoriteActionArgs
	_args.Req = req
	var _result FavoriteSrvFavoriteActionResult
	if err = p.Client_().Call(ctx, "FavoriteAction", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *FavoriteSrvClient) FavoriteList(ctx context.Context, req *DouyinFavoriteListRequest) (r *DouyinFavoriteListResponse, err error) {
	var _args FavoriteSrvFavoriteListArgs
	_args.Req = req
	var _result FavoriteSrvFavoriteListResult
...
type FavoriteSrvProcessor struct {
	processorMap map[string]thrift.TProcessorFunction
	handler      FavoriteSrv
}

func (p *FavoriteSrvProcessor) AddToProcessorMap(key string, processor thrift.TProcessorFunction) {
	p.processorMap[key] = processor
}

func (p *FavoriteSrvProcessor) GetProcessorFunction(key string) (processor thrift.TProcessorFunction, ok bool) {
	processor, ok = p.processorMap[key]
	return processor, ok
}

func (p *FavoriteSrvProcessor) ProcessorMap() map[string]thrift.TProcessorFunction {
	return p.processorMap
}

func NewFavoriteSrvProcessor(handler FavoriteSrv) *FavoriteSrvProcessor {
	self := &FavoriteSrvProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self.AddToProcessorMap("FavoriteAction", &favoriteSrvProcessorFavoriteAction{handler: handler})
	self.AddToProcessorMap("FavoriteList", &favoriteSrvProcessorFavoriteList{handler: handler})
	return self
}
func (p *FavoriteSrvProcessor) Process(ctx context.Context, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
...
type favoriteSrvProcessorFavoriteAction struct {
	handler FavoriteSrv
}

func (p *favoriteSrvProcessorFavoriteAction) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := FavoriteSrvFavoriteActionArgs{}
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := FavoriteSrvFavoriteActionResult{}
...
type favoriteSrvProcessorFavoriteList struct {
	handler FavoriteSrv
}

func (p *favoriteSrvProcessorFavoriteList) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := FavoriteSrvFavoriteListArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := FavoriteSrvFavoriteListResult{}
...
func (p *FavoriteSrvFavoriteActionArgs) InitDefault() {
	*p = FavoriteSrvFavoriteActionArgs{}
}

var FavoriteSrvFavoriteActionArgs_Req_DEFAULT *DouyinFavoriteActionRequest

func (p *FavoriteSrvFavoriteActionArgs) GetReq() (v *DouyinFavoriteActionRequest) {
	if !p.IsSetReq() {
		return FavoriteSrvFavoriteActionArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *FavoriteSrvFavoriteActionArgs) SetReq(val *DouyinFavoriteActionRequest) {
	p.Req = val
}
...
func (p *FavoriteSrvFavoriteActionArgs) IsSetReq() bool {
	return p.Req != nil
}
...
func (p *FavoriteSrvFavoriteActionArgs) Field1DeepEqual(src *DouyinFavoriteActionRequest) bool {
...
func (p *FavoriteSrvFavoriteActionResult) InitDefault() {
	*p = FavoriteSrvFavoriteActionResult{}
}

var FavoriteSrvFavoriteActionResult_Success_DEFAULT *DouyinFavoriteActionResponse

func (p *FavoriteSrvFavoriteActionResult) GetSuccess() (v *DouyinFavoriteActionResponse) {
	if !p.IsSetSuccess() {
...
func (p *FavoriteSrvFavoriteActionResult) Field0DeepEqual(src *DouyinFavoriteActionResponse) bool {
...
func (p *FavoriteSrvFavoriteListArgs) InitDefault() {
	*p = FavoriteSrvFavoriteListArgs{}
}

var FavoriteSrvFavoriteListArgs_Req_DEFAULT *DouyinFavoriteListRequest

func (p *FavoriteSrvFavoriteListArgs) GetReq() (v *DouyinFavoriteListRequest) {
	if !p.IsSetReq() {
		return FavoriteSrvFavoriteListArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *FavoriteSrvFavoriteListArgs) SetReq(val *DouyinFavoriteListRequest) {
	p.Req = val
}
...
func (p *FavoriteSrvFavoriteListArgs) IsSetReq() bool {
	return p.Req != nil
}
...
func (p *FavoriteSrvFavoriteListArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *FavoriteSrvFavoriteListArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *FavoriteSrvFavoriteListArgs) Field1DeepEqual(src *DouyinFavoriteListRequest) bool {
...
func (p *FavoriteSrvFavoriteListResult) InitDefault() {
	*p = FavoriteSrvFavoriteListResult{}
}

var FavoriteSrvFavoriteListResult_Success_DEFAULT *DouyinFavoriteListResponse

func (p *FavoriteSrvFavoriteListResult) GetSuccess() (v *DouyinFavoriteListResponse) {
	if !p.IsSetSuccess() {
...
func (p *FavoriteSrvFavoriteListResult) Field0DeepEqual(src *DouyinFavoriteListResponse) bool {
