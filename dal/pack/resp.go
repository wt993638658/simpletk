...
func BuildMessageChatResp(err error) *message.DouyinMessageCharResponse {
	if err == nil {
...
func messageChatResp(err errno.ErrNo) *message.DouyinMessageCharResponse {
	return &message.DouyinMessageCharResponse{StatusCode: int32(err.ErrCode), StatusMsg: &err.ErrMsg}
}
